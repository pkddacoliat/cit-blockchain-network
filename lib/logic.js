  ...
  if (!moduleExists) {
    ...
    if (!studentExists) {
      ...
      if (gradeExists) {
        ...
        grade.stage = moduleInstance.deliveries[0].stage;
        grade.semester = moduleInstance.deliveries[0].semester;
        grade.crn = moduleInstance.crn;
        grade.moduleCode = moduleInstance.moduleCode;
        grade.courseTitle = moduleInstance.title;
        grade.creditsEarned = moduleInstance.credits;
